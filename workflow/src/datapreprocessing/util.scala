...
private [datapreprocessing] object util {  
 ...
 * */  
  ...
  def vectorToLabel(data:RDD[Vector],targetCol:Int,inputCol:Array[Int]):RDD[LabeledPoint] = {
 ...
 * */  
  ...
  * */
 def arrFromParamsString(params:HashMap[String,String],key:String,split:String = ","):Array[String] = {
   val value = params.get(key)
   if(value != None && !value.get.trim.equals("")) value.get.split(split) else Array.empty[String] 
 }

 def arrFromParamsDouble(params:HashMap[String,String],key:String,split:String = ","):Array[Double] = {
   val value = params.get(key)
   if(value != None && !value.get.trim.equals("")) value.get.split(split).map(_.toDouble) else Array.empty[Double] 
 }
 
 def arrFromParamsInt(params:HashMap[String,String],key:String,split:String = ","):Array[Int] = {
   val value = params.get(key)
   if(value != None && !value.get.trim.equals("")) value.get.split(split).map(_.toInt) else Array.empty[Int] 
 }
 
  def arrFromParamsBoolean(params:HashMap[String,String],key:String,split:String = ","):Array[Boolean] = {
   val value = params.get(key)
   if(value != None && !value.get.trim.equals("")) value.get.split(split).map(_.toBoolean) else Array.empty[Boolean] 
 }
